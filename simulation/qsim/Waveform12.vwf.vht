...
-- *****************************************************************************
-- Generated on "12/05/2019 15:07:38"
...
SIGNAL EXMEM_Z_out_WF : STD_LOGIC;
SIGNAL instrucao : STD_LOGIC_VECTOR(31 DOWNTO 0);
SIGNAL M_sel_beq_WF : STD_LOGIC;
...
SIGNAL out_sel_mux_beq : STD_LOGIC;
SIGNAL out_sel_mux_jump : STD_LOGIC;
...
-- list connections between master ports and signals
	clk => clk,
	EXMEM_Z_out_WF => EXMEM_Z_out_WF,
	instrucao => instrucao,
	M_sel_beq_WF => M_sel_beq_WF,
	...
	out_pc => out_pc,
	out_sel_mux_beq => out_sel_mux_beq,
	out_sel_mux_jump => out_sel_mux_jump,
